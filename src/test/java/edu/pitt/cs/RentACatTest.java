...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		Cat cat = r.getCat(2);
		assertNull("Null was not returned",cat);
	...
	public void testGetCatNumCats3() {
		...
		assertEquals("ID is not 2", 2, cat.getId());
	}
	...
	public void testCatAvailableFalseNumCats0() {
		...
		assertFalse("False was not returned", bool);
	...
	public void testCatAvailableTrueNumCats3() {
		...
		boolean bool = r.catAvailable(2);
		assertTrue("True was not returned", bool);
	...
	public void testCatExistsFalseNumCats0() {
		...
		assertFalse("Value is not false", bool);
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		r.addCat(c3);
		boolean bool = r.catExists(2);
		assertTrue("Value is not true", bool);
	...
	public void testListCatsNumCats0() {
		// TODO
		String string = r.listCats();
		assertEquals("String is not empty", "", string);
	}
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String string = r.listCats();
		assertEquals("String is incorrect", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", string);
	}
	...
	public void testRentCatFailureNumCats3() {
		...
		Mockito.when(c2.getRented()).thenReturn(true);
		boolean bool = r.rentCat(2);
		assertFalse("Value was not false", bool);
